...
public class Gecco2019<T extends Chromosome<T>> extends GeneticAlgorithm<T> {

    private static final long serialVersionUID = 5043503777821916152L;

    private final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(Gecco2019.class);

    // Constructor for StandardGA
    public Gecco2019(ChromosomeFactory<T> factory) {
        super(factory);
    }
