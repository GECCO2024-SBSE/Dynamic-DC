...
public class Gecco2019GA<T extends Chromosome<T>> extends GeneticAlgorithm<T> {

    private static final long serialVersionUID = 5043503777821916152L;

    private final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(Gecco2019GA.class);

    // Constructor for StandardGA
    public Gecco2019GA(ChromosomeFactory<T> factory) {
        super(factory);
    }
    ...
    protected void evolve() {
        ...
        double weightBest = 0.9;
        double weightWorst = 0.1;
        double fitness1 = 0.0;
        double fitness2 = 0.0;
